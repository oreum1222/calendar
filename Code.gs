...
var EXTRA_EVENTS = [
  ...
  ["산본고 여름방학","2026-07-10","학사","전체","doing","없음","7/10(금)~8/17(월) · 개학 8/18(화)"],
  ["군중고 여름방학","2026-07-20","학사","전체","doing","없음","7/20(월)~8/5(수) · 개학 8/6(목)"],
  ["용호고 여름방학","2026-07-21","학사","전체","doing","없음","7/21(화)~8/6(목) · 개학 8/7(금)"],
  ["수리고 여름방학","2026-07-20","학사","전체","doing","없음","7/20(월)~8/11(화) · 개학 8/12(수)"],
  ["홍진고 여름방학","2026-07-20","학사","전체","doing","없음","7/20(월)~8/9(일) · 개학 8/10(월)"],
  ["군포고 여름방학","2026-07-16","학사","전체","doing","없음","7/16(목)~8/17(월) · 개학 8/18(화)"],
  ...
  ["수리고 시험 분석글 블로그 업로드","2026-07-06","홍보","지연T","todo","없음","!업로드 7/6 22시 ~ 7/7 04시 (시험 7/6 월)"],
  ...
  ["방학 특강 시트 작성","2026-07-05","행정","은규T, 지연T, 다미T, 해솔T, 원철T","todo","없음","!7/5(일) 23:59 마감 · 원장 기입분 바탕으로 본인란 작성 · 가경T 제외 전원"],
  ["학교별 시험지 취합","2026-07-11","행정","은규T, 지연T, 다미T, 해솔T","todo","없음","!7/11(토)까지 · 종이=복합기실 학교별 분류함 / 이미지=PDF화 후 노션 업로드 · (기출분석 보고서는 방학 중) · 원철T·가경T 제외"],
  ["학교별 성적 취합(우수자·상승자·전원 기입)","2026-07-11","행정","은규T, 지연T, 다미T, 해솔T","todo","없음","!7/11(토)까지 · 구글폼 미제출자 점수 전수조사 · 한 명도 빠짐없이 전원 기입 · 원철T·가경T 제외"],
  ["블로그 글에 학원 홈페이지 링크 추가","2026-07-26","홍보","전체","todo","없음","!7/26(일)까지 · 올해 본인이 쓴 블로그 글 수정하여 학원 사이트 주소 추가 (검색 상단 노출용) · 강사진 전원"],
  ["새이솔 문학 — 작품선정·발췌·보기·유형(다음 차수)","2026-07-29","출제","가경T","todo","없음","!7/29(수) 08:00 마감 · 작품 선정/발췌, 보기 개요, 문항 유형"],
  ["새이솔 문학 — 초고 출제(다음 차수)","2026-08-06","출제","가경T","todo","없음","!8/6(목) 08:00 마감 · 초고 출제"],
  ["모닝테스트 제작 — 7/28(화) 국어","2026-07-27","출제","가경T","todo","없음","!7/27(월) 마감(테스트 하루 전) · 고1 국어 30분(8:30~9:00) 배운내용 확인 · 문제+답지 2026mexx@gmail.com 제출"],
  ["모닝테스트 제작 — 8/4(화) 국어","2026-08-01","출제","가경T","todo","없음","!8/1(토) 마감(테스트 3일 전) · 고1 국어 30분 · 문제+답지 2026mexx@gmail.com 제출"],
  ["모닝테스트 제작 — 8/11(화) 국어","2026-08-08","출제","가경T","todo","없음","!8/8(토) 마감(테스트 3일 전) · 고1 국어 30분 · 문제+답지 2026mexx@gmail.com 제출"],
  ["수능완성 약술 유형서 초고 제출","2026-08-15","출제","원철T","todo","없음","!8/15(토) 마감 · 수능완성 약술 유형서 초고 제출"],
  ["고전문학 종강 가정통신문 발송 — 은규T","2026-08-07","행정","은규T","todo","없음","!8/7(금) 고전문학 종강 맞춰 발송 · 대봉투 없어 학부모 PDF 발송 권장 · 전체 문자에 카톡 채널 채팅 링크 첨부(가정통신문 산출 안내, 궁금하신 분 카톡 유도)"],
  ["고전문학 종강 가정통신문 발송 — 다미T","2026-08-12","행정","다미T","todo","없음","!8/12(수) 고전문학 종강 맞춰 발송 · 대봉투 없어 학부모 PDF 발송 권장 · 전체 문자에 카톡 채널 채팅 링크 첨부(가정통신문 산출 안내, 궁금하신 분 카톡 유도)"],
  ["고전문학 종강 가정통신문 발송 — 지연T","2026-08-16","행정","지연T","todo","없음","!8/16(일) 고전문학 종강 맞춰 발송 · 대봉투 없어 학부모 PDF 발송 권장 · 전체 문자에 카톡 채널 채팅 링크 첨부(가정통신문 산출 안내, 궁금하신 분 카톡 유도)"],
  ["새이솔 현대시 2차 선정 메일 발송","2026-08-03","출제","가경T","todo","없음","!8/3(월) 08:00 마감 · 현대시 2차 선정 메일 발송"],
  ["군포고 3차고사","2026-09-30","학사","전체","doing","없음","9/30(수)~10/6(화)"],
  ["군포중앙고 3차고사","2026-09-29","학사","전체","doing","없음","9/29(화)~10/2(금)"],
  ["산본고 3차고사","2026-10-12","학사","전체","doing","없음","10/12(월)~10/16(금)"],
  ["수리고 3차고사","2026-09-30","학사","전체","doing","없음","9/30(수)~10/8(목)"],
  ["용호고 3차고사","2026-09-28","학사","전체","doing","없음","9/28(월)~10/2(금)"],
  ["흥진고 3차고사","2026-09-29","학사","전체","doing","없음","9/29(화)~10/2(금)"],
  ["수원외고 3차고사","2026-09-29","학사","전체","doing","없음","9/29(화)~10/2(금)"],
  ["군포고 4차고사","2026-12-14","학사","전체","doing","없음","12/14(월)~12/18(금)"],
  ["군포중앙고 4차고사","2026-12-08","학사","전체","doing","없음","12/8(화)~12/11(금)"],
  ["산본고 4차고사","2026-12-17","학사","전체","doing","없음","12/17(목)~12/23(수)"],
  ["수리고 4차고사","2026-12-04","학사","전체","doing","없음","12/4(금)~12/11(금)"],
  ["용호고 4차고사","2026-12-02","학사","전체","doing","없음","12/2(수)~12/9(수)"],
  ["흥진고 4차고사","2026-12-02","학사","전체","doing","없음","12/2(수)~12/8(화)"],
  ["수원외고 4차고사","2026-12-01","학사","전체","doing","없음","12/1(화)~12/4(금)"],
  ["군포고 겨울방학식","2027-01-06","학사","전체","doing","없음","1/6(수)"],
  ["군포중앙고 겨울방학식","2026-12-24","학사","전체","doing","없음","12/24(목)"],
  ["수리고 겨울방학식","2026-12-18","학사","전체","doing","없음","12/18(금)"],
  ["용호고 겨울방학식","2026-12-28","학사","전체","doing","없음","12/28(월)"],
  ["흥진고 겨울방학식","2026-12-30","학사","전체","doing","없음","12/30(수)"],
  ["수원외고 겨울방학식","2026-12-24","학사","전체","doing","없음","12/24(목)"],
  ["수능 기초 1주차 숙제 정리","2026-08-22","출제","가경T, 김규민, 진채현, 김예담","todo","없음","!8/22(토) 10시 · 수능 기초 1주차 숙제 정리"],
  ["수능 기초 2주차 주간지 배치 정리","2026-08-22","출제","가경T, 김규민, 진채현, 김예담","todo","없음","!8/22(토) 10시 · 수능 기초 2주차 주간지(들어갈 세트) 배치 정리"],
  ["수능 기초 2주차 해설지 작성","2026-08-24","출제","가경T","todo","없음","!8/24(월) 23:59 · 수능 기초 2주차 해설지 작성 (가경T 단독)"],
  ["수능 기초 2주차 검수","2026-08-25","출제","진채현, 김규민, 김예담","todo","없음","!8/25(화) 00:01 · 수능 기초 2주차 검수 (조교: 진채현·김규민·김예담)"]
];
