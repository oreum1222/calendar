...
var EXTRA_EVENTS = [
  ...
  ["산본고1(토·일반) 시험 분석글 블로그 업로드","2026-06-26","홍보","다미T","todo","없음","!시험 당일 업로드 필수"],
  ["산본고1(목·금반) 시험 분석글 블로그 업로드","2026-06-26","홍보","은규T","todo","없음","!시험 당일 업로드 필수"],
  ["산본고2 시험 분석글 블로그 업로드","2026-06-29","홍보","은규T","todo","없음","!시험 당일 업로드 필수"],
  ["용호고1 시험 분석글 블로그 업로드","2026-06-29","홍보","다미T","todo","없음","!시험 당일 업로드 필수"],
  ["수원외고2·용호고2 시험 분석글 블로그 업로드","2026-06-30","홍보","은규T","todo","없음","!시험 당일 업로드 필수"],
  ["중등 시험 분석글 블로그 업로드","2026-06-30","홍보","해솔T","todo","없음","!시험 당일 업로드 필수"],
  ["흥진고1·군포고2·흥진고2 시험 분석글 블로그 업로드","2026-07-01","홍보","은규T","todo","없음","!시험 당일 업로드 필수"],
  ["수리고(일요일반) 시험 분석글 블로그 업로드","2026-07-01","홍보","지연T","todo","없음","!시험 당일 업로드 필수"],
  ["중등 시험 분석글 블로그 업로드","2026-07-01","홍보","해솔T","todo","없음","!시험 당일 업로드 필수"],
  ["중등 시험 분석글 블로그 업로드","2026-07-02","홍보","해솔T","todo","없음","!시험 당일 업로드 필수"],
  ["군포고1 시험 분석글 블로그 업로드","2026-07-02","홍보","은규T","todo","없음","!시험 당일 업로드 필수"],
  ["수리고 시험 분석글 블로그 업로드","2026-07-05","홍보","지연T","todo","없음","!시험 당일 업로드 필수"],
  ["수리고(일요일반) 시험 분석글 블로그 업로드","2026-07-06","홍보","지연T","todo","없음","!시험 당일 업로드 필수"],
  ["군포중앙고2 시험 분석글 블로그 업로드","2026-07-07","홍보","은규T","todo","없음","!시험 당일 업로드 필수"],
  ["군포중앙고1 시험 분석글 블로그 업로드","2026-07-07","홍보","다미T","todo","없음","!시험 당일 업로드 필수"]
];
